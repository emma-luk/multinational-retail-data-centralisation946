...
def main():
    ...
    extract_clean_load_store_data(data_extractor, data_cleaning, db2)

    # Task 6: Extract and clean the product details
    extract_clean_load_products_data(data_extractor, data_cleaning, db2)

    # Task 7: Retrieve and clean the orders table
    extract_clean_load_orders_data(data_extractor, data_cleaning, db, db2)

    # Task 8: Retrieve and clean the date events data
    extract_clean_load_date_events_data(data_extractor, data_cleaning, db2)

def extract_clean_load_store_data(data_extractor, data_cleaning, db2):
    # Extract
    store_data = data_extractor.extract_all_stores("https://aqj7u5id95.execute-api.eu-west-1.amazonaws.com/prod/number_stores",
...
def extract_clean_load_products_data(data_extractor, data_cleaning, db2):
    # Extract
...
def extract_clean_load_orders_data(data_extractor, data_cleaning, db, db2):
...
def extract_clean_load_date_events_data(data_extractor, data_cleaning, db2):
